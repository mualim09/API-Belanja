...
<head>
    ...
    <link type="text/css" href="<?php echo __HOSTNAME__; ?>/template/assets/css/bs.css" rel="stylesheet">
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <i class="fa fa-check-circle"></i> Pendaftaran Berhasil
                </div>
                <div class="card-body">
                    <p class="card-text">Silahkan login di aplikasi.</p>
                </div>
            </div>
        </div>
    </div>
